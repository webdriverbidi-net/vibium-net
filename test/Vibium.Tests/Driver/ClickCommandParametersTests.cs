...
[TestFixture]
public class ClickCommandParametersTests
{
    [Test]
    public void TestCommandName()
    {
        ClickCommandParameters properties = new("myContextId", "mySelector");
        Assert.That(properties.MethodName, Is.EqualTo("vibium:click"));
    }
